...
httpServer.listen(PORT, '0.0.0.0', () => {
  console.log(`🏥 Aditya Hospital AI Server running on port ${PORT}`);
  console.log(`🔗 Health: http://localhost:${PORT}/health`);
  console.log(`📞 Twilio Webhook (voice): ${(process.env.SERVER_BASE_URL || 'http://localhost:3001')}/api/twilio/voice`);
});
